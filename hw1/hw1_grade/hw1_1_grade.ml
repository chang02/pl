...
let _ = check (fun () -> merge (l0, l0) = l0)
let _ = check (fun () -> merge (l1, l0) = l1)
let _ = check (fun () -> merge (l0, l2) = l2)
...
let _ = check (fun () -> merge (l5, l6) = [11; 12])
let _ = check (fun () -> merge (l6, l0) = l6)